...
The first frontend publication additionally requires the approved manual physical-device and
assistive-technology evidence. Automated browser emulation is a prerequisite, not a substitute for
that evidence.
