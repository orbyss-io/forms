...
- Keep .NET projects directly under `src/` or `tests/`, TypeScript under `src/typescript`, and repository tooling under `scripts/`; do not introduce `src/dotnet`, `tests/dotnet`, or a repository-level `eng` directory.
