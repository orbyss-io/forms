...
[ShellFeature(name: "Orbyss.Forms.Web.Submissions", DisplayName = "Orbyss Forms Form Submissions", Description = "Provides authenticated owner-scoped draft, submission, review, and attachment endpoints.")]
public sealed class OrbyssFormSubmissionsFeature(ShellSettings settings) : IWebShellFeature
{
    /// <inheritdoc />
    ...
    public void MapEndpoints(IEndpointRouteBuilder endpoints, IHostEnvironment? environment)
    {
        ...
        var group = endpoints.MapGroup(options.RoutePrefix).WithTags("Orbyss Forms Form Submissions");
