...
namespace ProgramKit.Localization.Web.Runtime;

/// <summary>Composes immutable localization resolution and bundle reads into one selected shell.</summary>
[ShellFeature(
    name: "ProgramKit.Localization.Web.Runtime",
    DisplayName = "Program Kit Localization Runtime",
    Description = "Provides independently configurable immutable message and bundle endpoints.")]
public sealed class ProgramKitLocalizationRuntimeFeature(ShellSettings settings) : IWebShellFeature
{
    /// <inheritdoc />
    ...
    public void MapEndpoints(IEndpointRouteBuilder endpoints, IHostEnvironment? environment)
    {
        ...
        var group = endpoints.MapGroup(options.RoutePrefix).WithTags("Program Kit Localization Runtime");
