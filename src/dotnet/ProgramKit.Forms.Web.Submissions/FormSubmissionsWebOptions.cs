...
public sealed class FormSubmissionsWebOptions
{
    ...
    public const string SectionName = "ProgramKit:Forms:SubmissionsWeb";
    /// <summary>Gets or sets the fixed endpoint prefix.</summary>
    public string RoutePrefix { get; set; } = "/program-kit/forms";
    ...
    public string ReviewPolicy { get; set; } = "ProgramKit.Forms.Submissions.Review";
