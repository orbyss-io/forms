...
[ShellFeature(name: "ProgramKit.Forms.Web.Management", DisplayName = "Program Kit Form Management", Description = "Provides authenticated form authoring, lifecycle, publication, and compatibility endpoints.")]
public sealed class ProgramKitFormManagementFeature(ShellSettings settings) : IWebShellFeature
{
    /// <inheritdoc />
    ...
    public void MapEndpoints(IEndpointRouteBuilder endpoints, IHostEnvironment? environment)
    {
        ...
        var group = endpoints.MapGroup(options.RoutePrefix).WithTags("Program Kit Form Management");
