...
[ShellFeature(name: "ProgramKit.Forms.Web.Runtime", DisplayName = "Program Kit Form Runtime", Description = "Provides independently configurable immutable form release endpoints.")]
public sealed class ProgramKitFormRuntimeFeature(ShellSettings settings) : IWebShellFeature
{
    /// <inheritdoc />
    ...
    public void MapEndpoints(IEndpointRouteBuilder endpoints, IHostEnvironment? environment)
    {
        ...
        var group = endpoints.MapGroup(options.RoutePrefix).WithTags("Program Kit Form Runtime");
