...
[ShellFeature(
    name: "ProgramKit.Localization.Web.Management",
    DisplayName = "Program Kit Localization Management",
    Description = "Provides authenticated catalog, import, export, lifecycle, and release-diff endpoints.")]
public sealed class ProgramKitLocalizationManagementFeature(ShellSettings settings) : IWebShellFeature
{
    /// <inheritdoc />
    ...
    public void MapEndpoints(IEndpointRouteBuilder endpoints, IHostEnvironment? environment)
    {
        ...
        var group = endpoints.MapGroup(options.RoutePrefix).WithTags("Program Kit Localization Management");
