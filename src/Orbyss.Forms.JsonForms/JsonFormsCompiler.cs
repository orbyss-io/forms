...
/// <summary>Compiles Orbyss Forms definitions to bundled JSON Schema and JSON Forms UI Schema.</summary>
public sealed class JsonFormsCompiler : IFormCompiler
{
    ...
    public const string WizardRendererId = "Orbyss.Forms.Wizard";

    /// <summary>Identifies the logical action-bar renderer contract an application must supply.</summary>
    public const string ActionBarRendererId = "Orbyss.Forms.ActionBar";
    ...
    /// <summary>Initializes the compiler with Orbyss Forms's secure default validator.</summary>
        ...
        CancellationToken cancellationToken)
    {
        var root = new JsonObject
        {
            ...
            ["$id"] = $"urn:orbyss:forms:{Uri.EscapeDataString(definition.Id.Value)}:{definition.Revision.Value.ToString(CultureInfo.InvariantCulture)}",
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            elementOptions["variant"] = "orbyss-forms-wizard";
    ...
    /// <summary>Maps provider-neutral layout kinds to JSON Forms or Orbyss Forms extension types.</summary>
